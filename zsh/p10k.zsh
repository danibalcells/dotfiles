# Generated by Powerlevel10k configuration wizard on 2024-11-11 at 16:03 EST.
...
# 24h time, round separators, round heads, round tails, 1 line, compact, few icons,
...
() {
  ...
  #
  #   PEWERLEVEL9K_DIR_NOT_WRITABLE_ICON_BEFORE_CONTENT=false
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{white}'     # was %248F (grey)
      local      clean='%F{green}'     # was %76F
      local   modified='%F{yellow}'    # was %178F
      local  untracked='%F{blue}'      # was %39F
      local conflicted='%F{red}'       # was %196F
    else
      # Styling for incomplete and stale Git status
      local       meta='%F{white}'     # was %244F
      local      clean='%F{white}'     # was %244F
      local   modified='%F{white}'     # was %244F
      local  untracked='%F{white}'     # was %244F
      local conflicted='%F{white}'     # was %244F
    fi
